    ...
    <div style={{fontWeight:350,lineHeight:"24px",fontFamily:'"Segoe UI Variable Text","Segoe UI",system-ui,sans-serif',background:"#fff",color:"#000"}}>
      ...
      <section style={{background:"#000",padding:"80px 48px",color:"#fff"}}>
        ...
        <div style={{display:"flex",gap:24}}>
          ...
          <a href="#" style={{color:"#0067b8",fontSize:16,fontWeight:350,textDecoration:"none"}}>Learn more</a>
        </div>
      </section>
      <section style={{padding:"48px 48px",color:"#000"}}>
        ...
        <a href="#" style={{fontSize:16,color:"#000",fontWeight:350,textDecoration:"none"}}>Learn more</a>
      </section>
      <section style={{padding:"48px 48px",background:"#f2f2f2",color:"#000"}}>
        ...
        <a href="#" style={{fontSize:16,color:"#000",fontWeight:350,textDecoration:"none"}}>Explore</a>
      </section>
      <section style={{padding:"48px 48px",color:"#000"}}>
        ...
        <a href="#" style={{fontSize:16,color:"#000",fontWeight:350,textDecoration:"none"}}>See portability</a>
      </section>
      <section style={{padding:"48px 48px",background:"#f2f2f2",color:"#000"}}>
        ...
        <a href="#" style={{fontSize:16,color:"#000",fontWeight:350,textDecoration:"none"}}>See colors</a>
      </section>
      <section style={{padding:"48px 48px",color:"#000"}}>
        ...
        <div style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:16}}>
          {["Surface Pro","Surface Laptop","Surface Laptop Ultra","Accessories","Surface Studio","Surface Hub"].map((n,i)=>(
            <div key={i} style={{background:"#f2f2f2",padding:24,borderRadius:2,textAlign:"center"}}>
              ...
              <a href="#" style={{fontSize:16,color:"#000",fontWeight:350,textDecoration:"none"}}>Shop now</a>
            </div>
          ))}
        </div>
      </section>
        ...
        <div style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:16}}>
          {["Find files faster","All the apps you need","Create pics in a flash"].map((t,i)=>(
            <div key={i} style={{background:"#fff",padding:24,borderRadius:2}}>
              ...
              <a href="#" style={{fontSize:16,color:"#000",fontWeight:350,textDecoration:"none"}}>Learn</a>
            </div>
          ))}
        </div>
      </section>
        ...
        <div style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:16}}>
          {["What is Surface?","Is Surface good for gaming?","Which Surface should I buy?"].map((q,i)=>(
            <div key={i} style={{background:"#f2f2f2",padding:24,borderRadius:2}}>
              ...
              <a href="#" style={{fontSize:16,color:"#000",fontWeight:350,textDecoration:"none",display:"block",marginTop:8}}>Learn</a>
            </div>
          ))}
        </div>
      </section>
        ...
        <div style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:16}}>
          {accessories.map((a,i)=>(
            <div key={i} style={{background:"#fff",padding:16,borderRadius:2}}>
              ...
              <a href="#" style={{fontSize:16,color:"#000",fontWeight:350,textDecoration:"none"}}>Shop now</a>
              <a href="#" style={{fontSize:16,color:"#000",fontWeight:350,textDecoration:"none",marginLeft:8}}>Details</a>
            </div>
          ))}
        </div>
      </section>
