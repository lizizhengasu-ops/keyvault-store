export default function HomePage() {
  ...
  return (
    <div style={{fontFamily:'"Segoe UI Variable Text","Segoe UI",system-ui,sans-serif',color:"#000",background:"#fff",lineHeight:"24px"}}>
      <div style={{background:"#fff",display:"flex",flexDirection:"column",alignItems:"center",padding:"80px 48px"}}>
        <div style={{maxWidth:1200,width:"100%"}}>
          ...
          <p style={{fontSize:20,fontWeight:400,lineHeight:"24px",color:"#fff",margin:"0 0 24px 0"}}>Back to school is here — students save 10% on select Surface and more.</p>
      ...
      <div style={{background:"#fff",padding:"48px 0",display:"flex",flexDirection:"column",alignItems:"center"}}>
        <div style={{maxWidth:1200,width:"100%",padding:"0 48px",display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:16}}>
          {["Your productivity, supercharged","XBOX Series X","Meet the latest Surface Laptop"].map((t,i)=>(
            <div key={i} style={{background:"#f2f2f2",padding:24,borderRadius:2}}>
              <img src={"https://picsum.photos/seed/feat"+i+"/400/200"} alt={t} style={{width:"100%",height:120,objectFit:"cover",marginBottom:12,borderRadius:2}} />
              <h2 style={{fontSize:20,fontWeight:600,color:"#000",margin:"0 0 8px 0",lineHeight:"24px"}}>{t}</h2>
              <p style={{fontSize:13,fontWeight:400,color:"#000",lineHeight:"20px",margin:"0 0 8px 0"}}>Discover the latest from Microsoft.</p>
              <a href="#" style={{fontSize:13,color:"#0067b8",fontWeight:400,textDecoration:"none"}}>Learn more</a>
            </div>
          ))}
        </div>
      </div>
      <div style={{background:"#000",padding:"48px 0",display:"flex",flexDirection:"column",alignItems:"center"}}>
