export default function B2BPage() {
  ...
  const links = []
  for(let i=0;i<150;i++) links.push("Resource "+(i+1))
  return (
    <div style={{fontFamily:'"Segoe UI Variable Text","Segoe UI",system-ui,sans-serif',background:"#fffdfb",color:"#17253d",lineHeight:"24px"}}>
      <div style={{padding:"80px 48px",maxWidth:1200,margin:"0 auto"}}>
        <section style={{marginBottom:48}}>
          ...
          <p style={{fontSize:12,fontWeight:400,lineHeight:"16px",color:"#0e1726",margin:"0 0 32px 0"}}>Solutions for every business. Empower your workforce with AI, security, and productivity.</p>
        ...
        <section style={{marginBottom:48}}>
          <h2 style={{fontSize:48,fontWeight:500,lineHeight:"56px",color:"#0e1726",margin:"0 0 32px 0"}}>Products for business</h2>
        ...
        <section style={{marginBottom:48}}>
          <h2 style={{fontSize:48,fontWeight:500,lineHeight:"56px",color:"#0e1726",margin:"0 0 32px 0"}}>Business solutions</h2>
        ...
        <section style={{marginTop:48}}>
          <h2 style={{fontSize:15,fontWeight:600,color:"#0e1726",lineHeight:"20px",margin:"0 0 16px 0"}}>Resources</h2>
          <div style={{display:"flex",flexWrap:"wrap",gap:4}}>
            {links.map((r,i)=>(<a key={i} href="#" style={{fontSize:11,color:"#616161",lineHeight:"16px",textDecoration:"none",padding:"2px 6px"}}>{r}</a>))}
          </div>
        </section>
      </div>
    </div>
