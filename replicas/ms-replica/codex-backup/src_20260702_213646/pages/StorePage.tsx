export default function StorePage() {
  ...
  return (
    <div style={{padding:"48px 48px",maxWidth:1200,margin:"0 auto"}}>
      <div style={{fontSize:34,fontWeight:100,color:"#000",marginBottom:32}}>Store</div>
      <p style={{fontSize:15,color:"#000",marginBottom:24}}>Browse Microsoft products</p>
      <div style={{display:"grid",gridTemplateColumns:"repeat(4,1fr)",gap:16}}>
        {items.map((n,i)=>(
          <div key={i} style={{padding:24,background:"#f2f2f2",borderRadius:2}}>
            ...
            <a href="#" style={{color:"#0078D4",fontSize:13,fontWeight:600}}>Shop now</a>
          </div>
        ))}
      </div>
    </div>
