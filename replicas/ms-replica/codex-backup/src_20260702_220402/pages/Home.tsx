export default function HomePage() {
  ...
  const footerSections = [
    ...
    {title:"Microsoft Store",links:["Account Profile","Download Center","Microsoft Store Support","Returns","Order tracking","Store locations"]},
    {title:"Education",links:["Microsoft in Education","Devices for Education","Microsoft Teams for Education","Microsoft 365 Education","Office Education","Educator training"]},
    {title:"Business",links:["Microsoft Cloud","Azure","Dynamics 365","Microsoft 365","Microsoft Power Platform","Microsoft Advertising"]},
    {title:"Developer & IT",links:["Visual Studio",".NET","Windows Server","Azure DevOps","Microsoft 365 Dev Center","Learn"]},
    {title:"Company",links:["Careers","About Microsoft","Company News","Privacy at Microsoft","Investors","Diversity and inclusion"]},
  ]
  return (
    <div style={{fontFamily:'"Segoe UI Variable Text","Segoe UI",system-ui,sans-serif',color:'#000',background:'#fff'}}>
      <div style={{background:'#fff',display:"flex",flexDirection:"column",alignItems:"center",padding:"80px 48px"}}>
        <div style={{maxWidth:1200,width:"100%"}}>
          <h1 style={{fontSize:48,fontWeight:500,lineHeight:"56px",color:'#000',margin:"0 0 12px 0"}}>New from Surface for Business</h1>
          <p style={{fontSize:20,fontWeight:400,lineHeight:"24px",color:'#000',margin:"0 0 24px 0"}}>Back to school is here—students save 10% on select Surface and more.</p>
          <div style={{display:"flex",gap:12}}>
            <a href="#" style={{background:"#0078D4",color:"#fff",padding:"6px 20px",fontSize:14,fontWeight:400,textDecoration:"none"}}>Shop now</a>
            <a href="#" style={{color:"#0078D4",fontSize:14,fontWeight:400,textDecoration:"none"}}>Pre-order Surface Laptop for Business</a>
          </div>
        </div>
        <div style={{marginTop:48,display:"grid",gridTemplateColumns:"repeat(4,1fr)",gap:16,width:"100%",maxWidth:1200}}>
          {products.slice(0,4).map((p,i)=>(
            <div key={i} style={{background:"#f2f2f2",padding:24,borderRadius:2}}>
              ...
              <h3 style={{fontSize:20,fontWeight:600,color:'#000',margin:"0 0 4px 0",lineHeight:"24px"}}>{p.name}</h3>
              <p style={{fontSize:13,fontWeight:400,color:'#000',lineHeight:"20px",margin:"0 0 8px 0"}}>{p.desc}</p>
              <div style={{display:"flex",gap:8}}>
                <a href="#" style={{fontSize:13,color:"#0078D4",fontWeight:400,textDecoration:"none"}}>{p.link}</a>
      ...
      <div style={{background:"#fff",padding:"48px 48px",display:"flex",flexDirection:"column",alignItems:"center"}}>
        <div style={{maxWidth:1200,width:"100%",display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:16}}>
          <div style={{background:"#f2f2f2",padding:24,borderRadius:2}}>
            ...
            <p style={{fontSize:13,fontWeight:400,color:'#000',lineHeight:"20px",margin:"0 0 8px 0"}}>Discover Microsoft 365 Copilot—your AI assistant for work.</p>
            <a href="#" style={{fontSize:13,color:"#0078D4",fontWeight:400,textDecoration:"none"}}>Learn more</a>
          </div>
          <div style={{background:"#f2f2f2",padding:24,borderRadius:2}}>
            ...
            <a href="#" style={{fontSize:13,color:"#0078D4",fontWeight:400,textDecoration:"none"}}>Shop now</a>
          </div>
          <div style={{background:"#f2f2f2",padding:24,borderRadius:2}}>
      ...
      <div style={{background:"#000",color:"#fff",padding:"48px 48px",display:"flex",flexDirection:"column",alignItems:"center"}}>
        <div style={{maxWidth:1200,width:"100%"}}>
          <h2 style={{fontSize:48,fontWeight:500,lineHeight:"56px",color:"#fff",margin:"0 0 16px 0"}}>Born to flex</h2>
          <p style={{fontSize:20,fontWeight:400,lineHeight:"24px",color:"#fff",margin:"0 0 24px 0"}}>Surface Pro 12-inch: the most flexible 2-in-1.</p>
          <a href="#" style={{color:"#0078D4",fontSize:14,fontWeight:400,textDecoration:"none"}}>Shop Surface Pro</a>
        </div>
      </div>
      <div style={{background:"#fff",padding:"48px 48px",display:"flex",flexDirection:"column",alignItems:"center"}}>
        <div style={{maxWidth:1200,width:"100%"}}>
          ...
          <div style={{display:"grid",gridTemplateColumns:"repeat(4,1fr)",gap:16}}>
            {[{name:"Copilot",desc:"AI-powered assistant"},{name:"Word",desc:"Write with confidence"},{name:"Excel",desc:"Analyze with AI"},{name:"PowerPoint",desc:"Create stunning presentations"}].map((p,i)=>(
          ...
          <div style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:16}}>
            {stories.map((s,i)=>(
              <div key={i} style={{background:"#fff",padding:24,borderRadius:2}}>
                ...
                <h3 style={{fontSize:20,fontWeight:600,color:'#000',margin:"0 0 8px 0",lineHeight:"24px"}}>{s.title}</h3>
                <p style={{fontSize:13,fontWeight:400,color:'#000',lineHeight:"20px",margin:"0 0 8px 0"}}>{s.desc}</p>
                <a href="#" style={{fontSize:13,color:"#0078D4",fontWeight:400,textDecoration:"none"}}>{s.link}</a>
              </div>
            ))}
          </div>
        </div>
      </div>
      <div style={{background:"#fff",padding:"24px 48px",display:"flex",justifyContent:"center"}}>
        <div style={{maxWidth:1200,width:"100%",display:"flex",gap:8,flexWrap:"wrap",alignItems:"center"}}>
      ...
      <div style={{background:"#f2f2f2",padding:"36px 72px 0",fontSize:11,lineHeight:"20px",color:"#616161"}}>
        ...
        <div style={{borderTop:"1px solid #e6e6e6",padding:"16px 0",marginTop:16,display:"flex",justifyContent:"space-between",fontSize:11}}>
          ...
          <div style={{display:"flex",gap:16}}>
            <a href="#" style={{fontSize:11,color:"#616161",textDecoration:"none"}}>Your Privacy Choices</a>
            <a href="#" style={{fontSize:11,color:"#616161",textDecoration:"none"}}>Consumer Health Privacy</a>
            <a href="#" style={{fontSize:11,color:"#616161",textDecoration:"none"}}>Sitemap</a>
            <a href="#" style={{fontSize:11,color:"#616161",textDecoration:"none"}}>Contact Microsoft</a>
