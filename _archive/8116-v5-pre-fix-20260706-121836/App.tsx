...
const NAV_ITEMS = [
  ...
  {label:"Products",to:"/products"},{label:"Cart ({count})",to:"/cart"},
    ...
    <footer style={{
      ...
      <div style={{maxWidth:1200,margin:"0 auto",padding:"36px 72px 0",display:"grid",gridTemplateColumns:"repeat(6,1fr)",gap:24}}>
        {FOOTER_SECTIONS.map((s,i)=>(
          <div key={i}>
            ...
            {s.links.map((l,j)=>(<Link key={j} to="/" style={{
      ...
      <div style={{maxWidth:1200,margin:"0 auto",padding:"16px 72px",borderTop:"1px solid #e6e6e6",display:"flex",justifyContent:"space-between",fontSize:11,lineHeight:"20px"}}>
        ...
        <div style={{display:"flex",gap:16,fontSize:11,lineHeight:"20px",color: isWin ? "#ffffff" : isSurf ? "#000000" : isStore ? "#000000" : "#616161"}}>
          <Link to="/" style={{fontSize:11,color: isWin ? "#ffffff" : isSurf ? "#000000" : isStore ? "#000000" : "#616161",lineHeight:"20px",textDecoration:"none",fontWeight: isSurf ? 350 : 400}}>Your Privacy Choices</Link>
          <Link to="/" style={{fontSize:11,color: isWin ? "#ffffff" : isSurf ? "#000000" : isStore ? "#000000" : "#616161",lineHeight:"20px",textDecoration:"none",fontWeight: isSurf ? 350 : 400}}>Consumer Health Privacy</Link>
          <Link to="/" style={{fontSize:11,color: isWin ? "#ffffff" : isSurf ? "#000000" : isStore ? "#000000" : "#616161",lineHeight:"20px",textDecoration:"none",fontWeight: isSurf ? 350 : 400}}>Sitemap</Link>
          <Link to="/" style={{fontSize:11,color: isWin ? "#ffffff" : isSurf ? "#000000" : isStore ? "#000000" : "#616161",lineHeight:"20px",textDecoration:"none",fontWeight: isSurf ? 350 : 400}}>Contact Microsoft</Link>
