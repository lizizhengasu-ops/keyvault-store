      ...
      <div style={{padding:"80px 48px",maxWidth:1200,margin:"0 auto"}}>
        <section style={{marginBottom:48}}>
          ...
          <div style={{display:"flex",gap:12}}>
            <Link to="/b2b" style={{background:"#0078D4",color:"#fff",padding:"6px 20px",fontSize:16,fontWeight:400,textDecoration:"none"}}>Start free trial</Link>
            <Link to="/b2b" style={{color:"#0067b8",fontSize:16,fontWeight:400,textDecoration:"none"}}>Compare plans</Link>
          </div>
        </section>
        <section style={{marginBottom:48}}>
          ...
          <div style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:16}}>
            {prods.map((p,i)=>(
              <div key={i} style={{background:"#fff",padding:20,borderRadius:2}}>
                ...
                <Link to="/b2b" style={{fontSize:16,color:"#0067b8",fontWeight:400,textDecoration:"none"}}>Learn more</Link>
              </div>
            ))}
          </div>
        </section>
          ...
          <div style={{display:"grid",gridTemplateColumns:"repeat(5,1fr)",gap:12}}>
            {solutions.map((s,i)=>(
              <div key={i} style={{background:"#fff",padding:12,borderRadius:2,textAlign:"center"}}>
                ...
                <Link to="/b2b" style={{fontSize:12,color:"#0067b8",fontWeight:400,textDecoration:"none"}}>Learn</Link>
              </div>
            ))}
          </div>
        </section>
        ...
        <div style={{display:"flex",flexWrap:"wrap",gap:2,marginTop:16}}>
          {links.map((l,i)=>(<Link key={i} to="/b2b" style={{fontSize:11,color:"#616161",lineHeight:"16px",textDecoration:"none",padding:"2px 4px"}}>{l}</Link>))}
        </div>
      </div>
    </div>
  )
