  ...
  return (
    <div style={{fontWeight:350,lineHeight:"24px"}}>
      <section style={{background:"linear-gradient(180deg,#000 0%,#1a1a1a 100%)",padding:"80px 48px",color:"#fff"}}>
        ...
        <p style={{fontSize:72,fontWeight:350,lineHeight:"19.5px",color:"#fff",maxWidth:500}}>The most versatile laptop with tablet portability, touchscreen, and Surface Pen support.</p>
