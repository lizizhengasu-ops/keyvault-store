  ...
  return (
    <BrowserRouter>
      <div style={{fontFamily:'"Segoe UI Variable Text","Segoe UI",system-ui,sans-serif',color:"#000",background:"#fff",minHeight:"100vh"}}>
        <nav style={{height:54,background:"transparent",display:"flex",alignItems:"center",padding:"0 48px",position:"fixed",top:0,left:0,right:0,zIndex:100,fontSize:13,fontWeight:400,lineHeight:"54px",color:"#262626"}}>
        ...
        <footer style={{background:"#F2F2F2",color:"#616161",fontSize:11,lineHeight:"20px"}}>
