  ...
  return (
    <BrowserRouter>
      <div style={{fontFamily:'"Segoe UI Variable Text","Segoe UI",system-ui,sans-serif',color:"#000",background:"#fff",minHeight:"100vh"}}>
        <nav style={{height:54,background:"transparent",display:"flex",alignItems:"center",padding:"0 48px",position:"fixed",top:0,left:0,right:0,zIndex:100,fontSize:16,fontWeight:400,lineHeight:"normal",color:"#262626"}}>
          ...
          <div style={{display:"flex",marginLeft:24,gap:0}}>
            {NAV_ITEMS.map((n,i)=>(
              <Link key={i} to={n.to} style={{color:"#262626",textDecoration:"none",fontSize:16,fontWeight:400,lineHeight:"normal",padding:"0 16px"}}>{n.label}</Link>
            ))}
          </div>
        </nav>
